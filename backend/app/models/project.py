...
Used for server-side persistent project state, avoiding passing large amounts of data between frontend API calls
"""
...
class Project:
    ...
    # Ontology information (filled after endpoint 1 generation)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None

    # Graph information (filled after endpoint 2 completion)
