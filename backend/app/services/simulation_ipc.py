...
logger = get_logger('parallelworld.simulation_ipc')
    ...
    def send_interview(
        ...
        Args:
            ...
            platform: Specified platform (optional)
                ...
                - None: For dual-platform simulation, interview both platforms; for single-platform, interview that platform
            timeout: Timeout
    ...
    def send_batch_interview(
        ...
        Args:
            ...
            platform: Default platform (optional, overridden by each interview item's platform)
                ...
                - None: For dual-platform simulation, each agent interviews both platforms
            timeout: Timeout
