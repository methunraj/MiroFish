...
- Each entity is an "account" or "subject" that can express opinions, interact, and spread information on social media
...
Therefore, **entities must be real-world subjects that can express opinions and interact on social media**:
...
A. **Fallback types (must be included, placed as the last 2 in the list)**:
   - `Person`: The fallback type for any natural person individual. When a person does not belong to any other more specific person type, classify them here.
   - `Organization`: The fallback type for any organization. When an organization does not belong to any other more specific organization type, classify it here.
...
- Various people will appear in the text, such as "primary/secondary school teachers", "passerby A", "a certain netizen"
...
- Professor: an academic scholar or researcher
- Journalist: a reporter or news writer
- Celebrity: a famous person or social media influencer
- Executive: a senior corporate executive
- Official: a government official
- Lawyer: a legal practitioner
- Doctor: a medical practitioner

**Individual (Fallback)**:
- Person: any natural person (use when not fitting the specific types above)

**Organization (Specific)**:
- University: a higher education institution
- Company: a corporate enterprise
- GovernmentAgency: a government body or regulatory agency
...
"""
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # API limit: max 10 custom entity types, max 10 custom edge types
        MAX_ENTITY_TYPES = 10
        MAX_EDGE_TYPES = 10
    ...
    def generate_python_code(self, ontology: Dict[str, Any]) -> str:
        ...
        code_lines = [
            ...
            'Auto-generated by Parallel World for social opinion simulation',
            '"""',
            '',
