...
def _ensure_utf8_stdout():
    ...
    Fix garbled text in Windows console
    """
...
def setup_logger(name: str = 'parallelworld', level: int = logging.DEBUG) -> logging.Logger:
    """
    Set up logger
...
def get_logger(name: str = 'parallelworld') -> logging.Logger:
    """
    Get logger (create one if it does not exist)
