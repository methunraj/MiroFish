...
logger = get_logger('parallelworld.api.report')
...
# ============== Report Progress & Section Endpoints ==============
...
def get_report_sections(report_id: str):
    """
    Get list of generated sections (section-based output)
...
def get_agent_log(report_id: str):
    ...
    Get every step action during report generation in real-time, including:
    - Report start, planning start/complete
    - Each section's start, tool call, LLM response, completion
