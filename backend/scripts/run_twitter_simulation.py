...
This script reads parameters from a configuration file to execute the simulation, enabling full automation
...
class TwitterSimulationRunner:
    ...
    def _get_active_agents_for_round(
        ...
        # Calculate activation probability for each agent based on its configuration
        candidates = []
...
async def main():
    ...
    # Initialize logging configuration (use fixed file names, clean old logs)
...
def setup_signal_handlers():
    ...
    Allow the program to cleanly release resources (close database, environment, etc.)
    """
