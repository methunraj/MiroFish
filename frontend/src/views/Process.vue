    ...
    <div class="main-content">
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          <!-- Graph Visualization (display when data is available) -->
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, the LLM analyzes the content and automatically generates an ontology structure suitable for sentiment simulation (entity types + relationship types)
                </div>
              </div>
...
const goToNextStep = () => {
  // TODO: Proceed to Environment Setup
...
const renderGraph = () => {
  ...
  // Transparent wide lines for click detection
