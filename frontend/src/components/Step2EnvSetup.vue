    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': phase === 0, 'completed': phase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Create a new simulation instance, fetch simulation world parameter template
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 1, 'completed': phase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Automatically invoke tools to organize entities and relationships from the knowledge graph, initialize simulation agents, and assign unique behaviors and memories based on real-world seeds
          </p>
      ...
      <div class="step-card" :class="{ 'active': phase === 2, 'completed': phase > 2 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            LLM intelligently configures world time flow, recommendation algorithms, each agent's active time periods, posting frequency, event triggers, and other parameters based on simulation requirements and real-world seeds
          </p>
          ...
          <div v-if="simulationConfig" class="config-detail-panel">
            ...
            <div class="config-block">
              <div class="config-grid">
                ...
                <div class="config-item">
                  <span class="config-item-label">Minutes/Round</span>
      ...
      <div class="step-card" :class="{ 'active': phase === 3, 'completed': phase > 3 }">
        ...
        <div class="card-content">
          <p class="api-note">POST /api/simulation/prepare</p>
          <p class="description">
            Automatically generate initial activation events and trending topics based on narrative direction, guiding the initial state of the simulation world
          </p>
          ...
          <div v-if="simulationConfig && autoGeneratedRounds" class="rounds-config-section">
            <div class="rounds-header">
              <div class="header-left">
                ...
                <span class="section-desc">Parallel World automatically simulates <span class="desc-highlight">{{ simulationConfig?.time_config?.total_simulation_hours || '-' }}</span> hours, each round represents <span class="desc-highlight">{{ simulationConfig?.time_config?.minutes_per_round || '-' }}</span> minutes of elapsed time</span>
              </div>
              ...
              <div v-else class="rounds-content auto" key="auto">
                <div class="auto-info-card">
                  ...
                  <div class="auto-content">
                    ...
                    <div class="auto-desc">
                      <p class="highlight-tip" @click="useCustomRounds = true">If this is your first run, we strongly recommend switching to ‘Custom mode’ to reduce simulation rounds for quick preview and lower error risk</p>
                    </div>
                  </div>
                </div>
              </div>
...
// State
const phase = ref(0) // 0: init, 1: generating profiles, 2: generating config, 3: done
...
// Calculate total topics across all profiles
...
const startPrepareSimulation = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // Set expected agent count immediately (from prepare API response)
...
.badge.success { background: var(--bg-surface); color: var(--success); }
.badge.processing { background: var(--accent); color: var(--bg-raised); }
.badge.pending { background: var(--bg-surface); color: var(--text-faint); }
.badge.accent { background: var(--bg-surface); color: var(--accent); }
...
.profile-modal-overlay {
  ...
  right: 0;
  bottom: 0;
  background: rgba(0, 0, 0, 0.6); /* modal overlay - intentional darkening */
  display: flex;
  align-items: center;
